...
public class BookStoreApbDbContext :
    AbpDbContext<BookStoreApbDbContext>,
    ...
    IIdentityDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(BookStoreApbConsts.DbTablePrefix + "YourEntities", BookStoreApbConsts.DbSchema);
